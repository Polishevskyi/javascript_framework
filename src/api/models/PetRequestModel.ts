...
class PetRequestModel extends BaseModel {
  ...
  constructor({ id, category, name, photoUrls, tags, status }: PetRequestData = {}) {
  ...
  static fromJson(json: PetRequestData): PetRequestModel {
    return new PetRequestModel(json);
  }
}

export default PetRequestModel;
export type { PetRequestData };
